...
public class Placementactivityadmin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_placementadmin);
    ...
    private void sendMessage() {
        ...
        if (!message.isEmpty()) {
            ...
            // Save to Firestore
            firestore.collection("placement_chat").add(chatMessage);
                    ...
                    .addOnSuccessListener(taskSnapshot -> {
                        ...
                        fileRef.getDownloadUrl()
                                .addOnSuccessListener(uri -> {
                                    ...
                                    firestore.collection("placement_chat").add(imageMessage)

...
public class Culturalactivityadmin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_culturaladmin);
    ...
    private void sendMessage() {
        ...
        if (!message.isEmpty()) {
            ...
            // Save to Firestore
            firestore.collection("cultural_chat").add(chatMessage);
                    ...
                    .addOnSuccessListener(taskSnapshot -> {
                        ...
                        fileRef.getDownloadUrl()
                                .addOnSuccessListener(uri -> {
                                    ...
                                    firestore.collection("cultural_chat").add(imageMessage)

...
public class Conferenceactivityadmin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_conferenceadmin);
    ...
    private void sendMessage() {
        ...
        if (!message.isEmpty()) {
            ...
            // Save to Firestore
            firestore.collection("conference_chat").add(chatMessage);
                    ...
                    .addOnSuccessListener(taskSnapshot -> {
                        ...
                        fileRef.getDownloadUrl()
                                .addOnSuccessListener(uri -> {
                                    ...
                                    firestore.collection("conference_chat").add(imageMessage)
